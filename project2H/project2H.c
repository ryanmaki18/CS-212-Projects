 ...
 */
    ...
    for (int i = 0 ; i < 8 ; i++){
        ...
        alloc_time = (double)(endTime.tv_sec - startTime.tv_sec) + ((double)(endTime.tv_usec - startTime.tv_usec) / 1000000.0);
        // Uncomment to print out all Random Arrays
        ...
        SortArray(A, sizes[i]);
        gettimeofday(&endTime, NULL);
        sort_time = (double)(endTime.tv_sec - startTime.tv_sec) + ((double)(endTime.tv_usec - startTime.tv_usec) / 1000000.0);
        // Uncomment to print out all Sorted Arrays
        // for(int j = 0; j < sizes[i]; j++){
        //     printf("A[%d] = %d\n", j, A[j]);
        // }
        ...
        DeallocateArray(A);
        gettimeofday(&endTime, NULL);
        dealloc_time = (double)(endTime.tv_sec - startTime.tv_sec) + ((double)(endTime.tv_usec - startTime.tv_usec) / 1000000.0);
